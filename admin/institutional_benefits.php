...
<div class="card card-flush">
		...
		<div class="card-header align-items-center py-5 gap-2 gap-md-5">
			...
			<!--end::Title-->
				...
				<!--begin::Add product-->
				<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-plus" style="font-size: 25px;"></i>Add benefits</a>
				<!--end::Add product-->
			</div>
			<!--end::Card toolbar-->
		</div>
		...
		<div class="card-body pt-0">
			...
			<table class="table align-middle table-striped table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
					...
					<tbody class="fw-bold text-gray-600">
						<?php
							$sql = "SELECT *,(SELECT f_name from hr_employee WHERE id=si.e_id) AS f_name ,(SELECT l_name from hr_employee WHERE id=si.e_id) AS l_name FROM hr_institutional_benefits si";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">New Benefits</h4>
      	...
      	<div class="col-md-12 fv-row fv-plugins-icon-container">
	     	...
	     	<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<textarea type="text" class="form-control form-control-solid" placeholder="Reason of Benefits" name="remarks" required></textarea>
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>	
       </div>
