	...
	<div class="col-6 col-md-4">
		...
		<a href="#" class="card bg-white hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body">
				...
				<label class="text-info" style="position: absolute;font-size: 30px;right: 20px;">0</label>
				<!--end::Svg Icon-->
	...
	<div class="col-6 col-md-4">
		...
		<a href="#" class="card bg-white hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body">
				...
				<label class="text-primary" style="position: absolute;font-size: 30px;right: 20px;">0</label>
				<!--end::Svg Icon-->
	...
	<div class="col-6 col-md-4">
		...
		<a href="#" class="card bg-white hoverable card-xl-stretch mb-5 mb-xl-8">
			...
			<div class="card-body">
				...
				<i class="bi bi-credit-card text-success" style="font-size: 40px;"></i>
				<label class="text-success" style="position: absolute;font-size: 30px;right: 20px;">0</label>
				<!--end::Svg Icon-->
				<div class="text-success fw-bolder fs-2 mb-2 mt-5">Loan</div>
				<div class="fw-bold text-black"></div>
			</div>
			<!--end::Body-->
		</a>
	...
	<div class="col-6 col-md-4">
		...
		<a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body text-center">
				...
				<label class="text-white" style="font-size: 30px;">0</label>
				<!--end::Svg Icon-->
				<div class="text-white fw-bolder fs-2 mb-2 mt-5">Pending leave</div>
				<div class="fw-bold text-white"></div>
			</div>
			<!--end::Body-->
		</a>
	...
	<div class="col-6 col-md-4">
		...
		<a href="#" class="card bg-success hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body text-center">
				...
				<label class="text-white" style="font-size: 30px;">0</label>
				<!--end::Svg Icon-->
				<div class="text-white fw-bolder fs-2 mb-2 mt-5">Loan Application</div>
				<div class="fw-bold text-white"></div>
			</div>
			<!--end::Body-->
		</a>
