<h1 class="text-success">Leave Report List</h1><br>
<div class="card card-flush">
		...
		<div class="card-header align-items-center py-5 gap-2 gap-md-5">
			...
			<!--end::Title-->
				...
				<!--begin::Add product-->
				<select type="date" name="" class="form-control form-control-solid w-200px ">
					<option>Employee Name</option>
				</select>
				From
				<input type="date" name="" class="form-control form-control-solid w-200px ">
				To
				<input type="date" name="" class="form-control form-control-solid w-200px ">
