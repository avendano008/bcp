...
if(isset($_SESSION['user_id'])) {
	if($_SESSION['user_type']=='topmanagement' || $_SESSION['user_type']=='background'){
		$id=$_SESSION['user_id'];
		$fullname=$_SESSION['f_name']." ".$_SESSION['l_name'];
		$_SESSION['user_type']='topmanagement';
		
		$sql = "SELECT a.*,
		IFNULL((SELECT name FROM hr_images i WHERE i.user_id=a.id AND user_type='topmanagement' ORDER BY i.id DESC LIMIT 1),'default.png') AS image,
