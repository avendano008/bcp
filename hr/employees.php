			...
			<table class="table align-middle table-striped table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
					...
					<thead>
						...
						<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
							...
							<th class="min-w-100px">Biometric</th>
      ...
      <div class="row">	
	     	<div class="col-md-6 fv-row fv-plugins-icon-container">
				...
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Biometric</label>
				...
				<div class="col-md-6 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<input type="date" class="form-control form-control-solid" placeholder="" name="date_of_leaving">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<!-- <div class="col-md-6 fv-row fv-plugins-icon-container">
				...
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<input type="text" class="form-control form-control-solid" placeholder="" name="sss" >
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<input type="text" class="form-control form-control-solid" placeholder="" name="pagibig" >
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<input type="text" class="form-control form-control-solid" placeholder="" name="philhealth" >
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						...
						<input type="text" class="form-control form-control-solid" placeholder="" name="tin" >
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
      ...
      <div class="row">	
	     	<div class="col-md-6 fv-row fv-plugins-icon-container">
				...
				<div class="col-md-6 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Contact Number</label>
						<input type="number" class="form-control form-control-solid" placeholder="" name="cp_number" required value="<?php echo$row['cp_number']?>" max >
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-6 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Date of Birth</label>
						<input type="text" class="form-control form-control-solid" id="date_of_birth1" placeholder="" name="date_of_birth" required value="<?php echo$row['date_of_birth']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-6 fv-row fv-plugins-icon-container">
				...
				<div class="col-md-6 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Date of Leaving</label>
						<input type="date" class="form-control form-control-solid" placeholder="" name="date_of_leaving" value="<?php echo$row['date_of_leaving']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">SSS</label>
						<input type="text" class="form-control form-control-solid" placeholder="" name="sss"  value="<?php echo$row['sss']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Pag-Ibig</label>
						<input type="text" class="form-control form-control-solid" placeholder="" name="pagibig"  value="<?php echo$row['pagibig']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Philhealth</label>
						<input type="text" class="form-control form-control-solid" placeholder="" name="philhealth"  value="<?php echo$row['philhealth']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
				<div class="col-md-12 fv-row fv-plugins-icon-container">
					<!--begin::Label-->
						<label class="required fs-5 fw-bold mb-2">Tin number</label>
						<input type="text" class="form-control form-control-solid" placeholder="" name="tin"  value="<?php echo$row['tin']?>">
						<!--end::Input-->
					<div class="fv-plugins-message-container invalid-feedback"></div>
				</div>
...
<script type="text/javascript">
	...
	$("#date_of_birth1").datepicker( { dateFormat: 'dd/mm/yy', maxDate: '-13Y' });
</script>