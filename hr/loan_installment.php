<h1 class="text-success">Loan Installment List</h1><br>
<div class="card card-flush">
		...
		<div class="card-header align-items-center py-5 gap-2 gap-md-5">
			...
			<!--end::Title-->
				...
				<!--begin::Add product-->
				<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-plus" style="font-size: 25px;"></i> Add Loan Installment</a>
				<!--end::Add product-->
			</div>
			<!--end::Card toolbar-->
		</div>
			...
			<table class="table align-middle table-striped table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
					...
					<thead>
						...
						<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
							...
							<th class="min-w-100px">Employee PIN</th>
							<th class="min-w-100px">Loan Id</th>
							<th class="min-w-100px">Loan Number</th>
							<th class="min-w-100px">Install amount</th>
							<th class="min-w-100px">Approve Date</th>
							<th class="min-w-100px">Receiver</th>
							<th class="min-w-100px">Install No.</th>
					...
					<tbody class="fw-bold text-gray-600">
						<tr>
							...
							<td class="pe-0">
								<a href="?page=<?php echo$_GET['page']?>&edit=" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
								<a href="?page=<?php echo$_GET['page']?>&edit=" class="btn btn-danger"><i class="bi bi-trash"></i></a>
							</td>
						</tr>
					</tbody>
					<!--end::Table body-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">New Archive</h4>
